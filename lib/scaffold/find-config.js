...
/**
 * Will return the path and primeaicore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'primeaicore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'primeaicore-node.json'))
  };
}
