...
var primeaicorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = primeaicorenode.version;
  var create = primeaicorenode.scaffold.create;
  var add = primeaicorenode.scaffold.add;
  var start = primeaicorenode.scaffold.start;
  var remove = primeaicorenode.scaffold.remove;
  var callMethod = primeaicorenode.scaffold.callMethod;
  var findConfig = primeaicorenode.scaffold.findConfig;
  var defaultConfig = primeaicorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the primeaicoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `primeaicore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ primeaicore-node add wallet-service');
      console.log('    $ primeaicore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ primeaicore-node remove wallet-service');
      console.log('    $ primeaicore-node remove insight-api');
      console.log();
    });
