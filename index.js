...
module.exports.services.primeaicoin = require('./lib/services/primeaid');
...
module.exports.cli.primeaicore = require('./lib/cli/primeaicore');
module.exports.cli.primeaicored = require('./lib/cli/primeaicored');

module.exports.lib = require('primeaicore-lib');
