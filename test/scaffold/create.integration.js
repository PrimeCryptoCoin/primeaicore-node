...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.primeai', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/primeaicore-node.json';
      ...
      config.services.should.deep.equal(['primeaid', 'web']);
      config.servicesConfig.primeaid.spawn.datadir.should.equal('./data');
