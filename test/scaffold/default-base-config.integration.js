...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    primeaid.spawn.datadir.should.equal(home + '/.primeai');
    primeaid.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/primeaid'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.primeaid.spawn.datadir.should.equal('./data2');
  });
});
